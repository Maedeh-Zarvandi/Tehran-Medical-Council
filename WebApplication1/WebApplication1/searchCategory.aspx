<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="searchCategory.aspx.cs" Inherits="WebApplication1.searchCategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <span style="color: #006600; font-size: medium"><strong>To find the name of the&nbsp; Hospitals, profit Clinics&nbsp; and their capacity with your desired doctor and your desired category :</strong></span><br />
    </p>
    <p>
